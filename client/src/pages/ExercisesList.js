...
export default function AllExercisesList() {
    ...
    const [exerciseListIsLoading, setExerciseListIsLoading] = React.useState(true)
                                    ...
                                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                        ...
                                        <tbody>
                                            ...
                                            Object.keys(exerciseList).map(exerciseId => 
                                                    ...
                                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{exerciseList[exerciseId].exerciseName}</th>

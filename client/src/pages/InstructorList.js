...
export default function StudentsList(){
    ...
    useEffect(function temp(){
      ...
      .then(res => {
        ...
        setStudentList(res.data.filter((user) => user.role == 'instructor'))
      })
        ...
        <div>
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-3">Nome do instrutor</th>
                                ...
                                <tbody>
                                    ...
                                    studentList.map(student => 
                                            ...
                                            <td class="px-4 py-3">
                                                ...
                                                <img class="w-10 h-10 p-1 rounded-full ring-2 ring-gray-300 dark:ring-gray-500" src="/img/avatar-man.jpg" alt="Bordered avatar" />
            ...
            <div>
                ...
                <Modal show={openStudentRegistrationModal} onClose={() => setOpenStudentRegistrationModal(false)}>
                    <Modal.Header>Cadastro de instrutor</Modal.Header>
                    <Modal.Body>
                        <StudentAccountCreationForm newUserRole={'instructor'}/>
                    </Modal.Body>     
                </Modal>
                ...
                <Modal show={openDeleteStudentModal} size="md" onClose={() => setOpenDeleteStudentModal(false)} popup>
                    ...
                    <div className="text-center">
                        ...
                        <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                            Deseja realmente remover o aluno selecionado?
                        </h3>
                        ...
                        <Button color="failure" onClick={() => setOpenDeleteStudentModal(false)}>
                            Cancelar
                        </Button>
                        </div>
                    </div>

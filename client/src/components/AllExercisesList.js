...
export default function AllExercisesList() {
    ...
    function submitForm(formData){
        ...
        axios.post(`http://localhost:8000/exercises`, formData)
        .then(res => {
            if((res.status) === 201){
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        ...
                        <tr>
                            <th scope="col" class="px-4 py-4">Nome do exercício</th>
                    ...
                    <tbody>
                        {
                          exerciseList.map(exercise => 
                                ...
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{exercise.exerciseName}</th>
                                <td class="px-4 py-3">{exercise.muscularGroup}</td>
                                <td class="px-4 py-3">{exercise.exerciseDescription}</td>
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Adicionar novo exercício</h3>
...
<div>
                ...
                <Modal show={openModal} onClose={() => setOpenModal(false)}>
                    <Modal.Header>Cadastro de novo exercício</Modal.Header>
                <Modal.Body>
                        
                       
            <div className="bg-white border border-gray-200 rounded-lg shadow sm:p-8 md:p-12 dark:bg-gray-800 dark:border-gray-700">
                
                <form onSubmit={handleSubmit}>
                    <div class="grid gap-6 mb-6">
                        
                        <div>
                            <label for="exerciseName" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nome do exercicio</label>
                            <input type="text" name="exerciseName" value={formData.exerciseName} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Nome do exercício" onChange={handleChange} required />
                        </div>
                        
                        <div class="mb-5">
                            <label for="trainingGoal" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Grupo de membros</label>
                            <select name="muscularGroup"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" onChange={handleChange} value={formData.muscularGroup} required>
                        ...
                        <div>
                            <label for="exerciseDescription" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Descrição</label>
                            <input type="text" name="exerciseDescription" value={formData.exerciseDescription} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Descrição do exercício" onChange={handleChange} required />
                        </div>
